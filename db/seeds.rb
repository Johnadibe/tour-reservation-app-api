...
@reservation = Reservation.create(start_end: '12-02-2023', end_date: '12-08-2023', user_id: @user.id,
    tour_id: @tour.id)
@reservation = Reservation.create(start_end: '13-04-2023', end_date: '13-08-2023', user_id: @user.id,
    tour_id: @tour.id)
@reservation = Reservation.create(start_end: '16-01-2023', end_date: '12-10-2023', user_id: @user.id,
    tour_id: @tour.id)
@reservation = Reservation.create(start_end: '30-06-2023', end_date: '12-12-2023', user_id: @user.id,
    tour_id: @tour.id)